...
implements ActionListener {
    ...
    private void setGUI() {
        ...
        Tree.addItemListener(new TreeLisener());
    ...
    private void setCenter() {
        if (garden != null) centerPlant = garden.getCenter().getName() + " Soil: " + garden.getCenter().getSoil();
        // repaints garden panel
        gardenPlot.repaint();
    }
    private void setBorder() {
        if (garden != null) borderPlant = garden.getBorder().getName() + " Soil: " + garden.getCenter().getSoil();
        gardenPlot.repaint();
    }
    private void setShade() {
        if (garden != null) shadePlant = garden.getShade().getName() + " Soil: " + garden.getCenter().getSoil();
        gardenPlot.repaint();
    }
...
//--------------------------------
    ...
    class TreeLisener implements ItemListener {
    	public void itemStateChanged(ItemEvent e){
